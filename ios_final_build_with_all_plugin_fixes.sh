...
post_install do |installer|
  ...
  installer.pods_project.targets.each do |target|
    target.build_configurations.each do |config|
      ...
      # Fix compile optimizations for extension compatibility
...
echo "Modified Podfile with fixes for all plugins"
...
echo "Final build with all plugin fixes completed."
