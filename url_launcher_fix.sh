...
echo "============================================================="
echo "Creating a focused URL launcher iOS plugin fix"
echo "============================================================="
...
public class URLLauncherPlugin: NSObject, FlutterPlugin, URLLauncherApi {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    if UIApplication.shared.canOpenURL(URL(string: "https://flutter.dev")!) {
...
echo "Creating a fix for Flutter xcconfig files..."
mkdir -p fix_output

# Create a script to add EXTENSION=0 to all xcconfig files
cat > fix_output/add_extension_flag.sh << 'EOF'
#!/bin/bash
...
chmod +x fix_output/add_extension_flag.sh

echo "Creating build script with appropriate flags..."
cat > fix_output/build_app.sh << 'EOF'
#!/bin/bash
...
./fix_output/add_extension_flag.sh
...
chmod +x fix_output/build_app.sh

echo "============================================================="
echo "URL launcher plugin fixed successfully!"
echo ""
echo "Next steps:"
echo "1. Run ./fix_output/add_extension_flag.sh to add EXTENSION=0 to xcconfig files"
echo "2. Run the build script: ./fix_output/build_app.sh"
echo "=============================================================" 